...
Source: "driver\antumbraglowv3beta.inf"; DestDir: {app}\driver
...
Filename: {sys}\rundll32.exe; Parameters: "setupapi,InstallHinfSection DefaultInstall 128 {app}\driver\antumbraglowv3beta.inf"; WorkingDir: {app}\driver; Flags: 32bit;
