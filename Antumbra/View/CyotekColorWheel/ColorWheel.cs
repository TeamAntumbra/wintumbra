    ...
    public class ColorWheel : Control, IColorEditor {
        ...
        protected override void OnKeyDown(KeyEventArgs e) {
            ...
            if(hue != color.H) {
                ...
                // As the Color and HslColor properties update each other, need to temporarily
                // disable this and manually set both otherwise the wheel "sticks" due to imprecise
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            if(this.AllowPainting) {
                ...
                // if the parent is using a transparent color, it's likely to be something like a
                // TabPage in a tab control so we'll draw the parent background instead, to avoid
                // having an ugly solid color
                ...
                // https://github.com/cyotek/Cyotek.Windows.Forms.ColorPicker/issues/1 - the linked
                // source doesn't do this hack yet draws with a smoother edge
        ...
        /// <summary>
        /// Gets or sets a value to be added to or subtracted from the <see cref="Color"/> property
        /// when the wheel selection is moved a large distance.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value to be added to or subtracted from the <see cref="Color"/> property
        /// when the wheel selection is moved a small distance.
        /// </summary>
        ...
        protected virtual void CalculateWheel() {
            ...
            // Only define the points if the control is above a minimum size, otherwise if it's too
            // small, you get an "out of memory" exceptions (of all things) when creating the brush
        ...
        /// <returns>
        /// <c>true</c> if the specified point is within the bounds of the color wheel; otherwise, <c>false</c>.
        /// </returns>
