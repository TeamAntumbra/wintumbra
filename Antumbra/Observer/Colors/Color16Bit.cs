...
namespace Antumbra.Glow.Observer.Colors {
    ...
    public class Color16BitUtil {
        ...
        /// Factor to scale the color with. Must be between 0 and 1.0 inclusive
        /// </param>
        public static Color16Bit ScaleColor(Color16Bit color, double scaleFactor) {
        ...
        /// <returns>
        /// 0 for negative values, 65535 for values larger than that, else the input value as a UInt16
        /// </returns>
