...
{
    public partial class SmartProcSettingsWindow : Form
    {
        private AntumbraSmartScreenProcessor ext;
        /// <summary>
        ...
        public SmartProcSettingsWindow(AntumbraSmartScreenProcessor ext)
        {
            this.ext = ext;
            InitializeComponent();
